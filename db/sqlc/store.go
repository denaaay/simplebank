...
type TransferTxResults struct {
	...
	ToAccount   Accounts  `json:"to_acccount"`
	FromEntry   Entries   `json:"from_entry"`
	ToEntry     Entries   `json:"to_entry"`
}

// TransferTx performs a money transfer from one account to other account
// It create a transfer record, add account entries, and update accounts' and balance within a single database transaction
